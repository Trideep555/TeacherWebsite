...
<section class="bg-[#f1f1f1] h-screen pt-12"> 
    ...
    <main class="bg-[#f1f1f1] justify-center items-center w-full gap-8 flex flex-wrap pt-10">
        <?php
        ...
        ?>
        <!-- cards -->
        <section class="bg-white relative w-96  rounded-2xl shadow-lg border-t-2 border-black/20 py-8 flex flex-col gap-4">
    ...
    <section class="bg-[#f1f1f1] w-full relative py-8">
        <ul  class="sticky flex gap-6 justify-center" >
            ...
            ?>
            <a class="h-8 w-8" href="hero.php?page=<?php echo $i;?>">
