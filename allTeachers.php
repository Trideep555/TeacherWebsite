...
if(isset($_REQUEST['search'])){
    ...
    @header("location:allTeachers.php?searchQuery=".$search);
}
...
if(isset($_REQUEST['filter'])){
    ...
    $location = "allTeachers.php?filtering=1&";
    if(!empty($subject)){
...
<section class="bg-[#f1f1f1] h-screen pt-12"> 
    ...
    <main class="justify-center items-center w-full gap-8 flex flex-wrap pt-10">
         <?php
            $teacherQuery = "SELECT * FROM `teacher-table` WHERE `activity` = 1 AND `role` = 'Teacher'";
    ...
    <section class="bg-[#f1f1f1] w-full relative py-8">
        <ul  class="sticky flex gap-6 justify-center" >
            <?php 
                $totalRows = "SELECT * FROM `teacher-table` WHERE `activity` = 1 AND `role` = 'Teacher'";
            ...
            ?>
            <a class="h-8 w-8" href="allTeachers.php?page=<?php echo $i;?>">
